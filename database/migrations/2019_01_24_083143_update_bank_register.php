...
class UpdateBankRegister extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::table('bank_register', function (Blueprint $table) {
            ...
            $table->integer('cash_register_id')->nullable()->default(0)->comment('cash register id, while cash out from cash register and enter into bank register')->change();
            $table->integer('trans_parent_id')->nullable()->default(0)->comment('id of the row connected which current transaction is working. Not needed now')->change();
            ...
            $table->string('deposited_same_day',3)->nullable()->default(null)->comment('if cash deposited on the same day')->change();
            ...
            $table->string('bank_consolidated',3)->nullable()->default('Y')->comment('Y')->change();
        }); 
    }
