...
<!-- Your custom  HTML goes here -->
        <div class="notes_txt"><i>Note: Details of Bank account opened for Election Expense should be added in "Your Election Profile"</i></div>
          ...
          <table class='table table-striped table-bordered'>
            <thead>
              <tr>
                ...
                <th style="text-align: center;">Bank Balance {{Config::get('constants.text_labels.amount')}}</th>    
            ...
            <tbody>
              ...
              <tr>
                ...
                <td style="text-align: center;">{{$row->bank_address}}</td>
                ...
                <td style="text-align: center;">
                  ...
                  function(){location.href='{{url("/admin/profile_edit/bank-detail-delete/$row->id")}}';})"><i class="fa fa-trash"></i></a>
              </td>
              </tr>
              @endforeach
              @endempty
