...
<div class='panel panel-default'>
    <div class='panel-heading'>
        ...
        <span class="frm_ins_sp"><i class="icon_wh guidelines_wh"></i>
            <a href="javascript:void(0);" onclick="goToGuideLines(11);" class="guide-ins-label">Guidelines & Instructions</a>
        </span>
        </div>
    
    <form method='POST' class='form-horizontal' action="{{url('/admin/schedule_selectio/formsave')}}" id="scheduleForm6" enctype="multipart/form-data">
    @csrf
    ...
    <div class='form-group'>
            ...
            <div class="col-sm-9">
                <select name="nature_expenses_id"  class='form-control' id="expenditure">
    ...
    <div class='form-group'>
            ...
            <div class="col-sm-9">
            <input type='number' name='rate' class='form-control' value=''/>
            </div>
    </div>

    <div class='form-group'>
            <label class="control-label col-sm-2">No of workers/agents kiosks</label>
            <div class="col-sm-9">
            <input type='number' name='no_agents_or_kiosks' class='form-control' value=''/>
            </div>
    </div>
...
title="This field is required">*</span></label>
    ...
    <input type="hidden" name="schedulename" value="schedule6"/>
    <div class='panel-footer'>
      ...
      @php
        echo $guideLines = getGuideLines(11);
      @endphp
