...
<div class='panel panel-default'>
        <div class='panel-heading'>
            ...
            <a href="javascript:void(0);" onclick="goToGuideLines(8);" class="guide-ins-label">Guidelines & Instructions</a>
        </span>
        
        </div>

        <form method='POST' class='form-horizontal' action="{{url('/admin/schedule_selectio/formsave')}}" id="scheduleForm3" enctype="multipart/form-data">
                @csrf
        ...
        <div class="col-sm-3">
                <textarea id ="vouchar_remarks" name="vouchar_remarks" class="form-control"></textarea>
                        ...
                        <input type="hidden" name="schedulename" value="schedule3" />
      ...
      @php
        echo $guideLines = getGuideLines(8);
      @endphp
