...
<div class='panel panel-default'>
    <div class='panel-heading'><span class="frm_ttl_sp">{{ $schedule_title }} <span style="padding-left:30px;font-size:11px;">
    ...
    <form method='POST' class='form-horizontal' action="{{url('/admin/schedule_selectio/formsave')}}" id="scheduleForm1" enctype="multipart/form-data">
    @csrf
    ...
    <div class='form-group'>
        <label class="control-label col-sm-2">Nature of Expenditure <span class="text-danger" 
            title="This field is required">*</span></label>
        <div class="col-sm-9">
            <select name="nature_id"  class='form-control' id="expenditure">
    ...
    <div class='form-group' id="populate_others">
        ...
        <div class="col-sm-5">
                <input type='text' name='other_per_name' class='form-control' id='other_per_name' value='' placeholder="Specify Name & Address"/> 
        </div>
    </div>
    </div>
    ...
    <input type="hidden" name="schedulename" value="schedule1"/>
    ...
    <div class='panel-footer'>
      ...
      @php
        echo $guideLines = getGuideLines(6);
      @endphp
