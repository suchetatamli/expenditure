...
<div class='panel panel-default'>
    <div class='panel-heading'>
        <span class="frm_ttl_sp">{{ $schedule_title }} <span style="padding-left:30px;font-size:11px;">
            ...
            <a href="javascript:void(0);" onclick="goToGuideLines(7);" class="guide-ins-label">Guidelines & Instructions</a>
        </span>
        </div>
    
    <form method='POST' class='form-horizontal' action="{{url('/admin/schedule_selectio/formsave')}}" id="scheduleForm2" enctype="multipart/form-data">
    @csrf
    ...
    <div class='form-group'>
            <label class="control-label col-sm-2">Name of Star Campaigner(s)<span class="text-danger" 
                    title="This field is required">*</span></label>
            <div class="col-sm-9">
            <input type='text' name='name_of_star_campaigne' class='form-control '  required="" value=''/>
            <p class="help-block">Use comma(,) if more than one Star Campaigner</p>
            </div>
    </div>

    <div class='form-group'>
            <label class="control-label col-sm-2">Name of Party of Star Campaigner<span class="text-danger" 
                    title="This field is required">*</span></label>
            <div class="col-sm-9">
            <input type='text' name='star_campaign_party' class='form-control ' required="" value=''/>
            </div>
    </div>
    ...
    <div class='form-group' id="populate_self">
        ...
        <div class='form-group'>
                <label class="control-label col-sm-2">Total Amount in Rs. <span class="text-danger" 
                    title="This field is required">*</span></label>
            <div class="col-sm-9">
                    <input type='text' name='total_amount' id='total_amount' required class='form-control' readonly min="1" value='0'/>   
            </div>
        </div>   
        </div>
    ...
    <input type="hidden" name="schedulename" value="schedule2"/>
    ...
    <div class='panel-footer'>
      ...
      @php
        echo $guideLines = getGuideLines(7);
      @endphp
