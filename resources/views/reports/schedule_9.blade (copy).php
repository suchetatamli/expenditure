...
<div class='panel panel-default'>
    ...
    <div class='panel-body' style="padding:20px 0px 0px 0px">
        ...
        <div class="print_area" id="print_area">
          ...
          <p>Details of Lump sum amount received from any person/company/firm/associations/body of persons etc. as loan, gift or donation
etc.</p>          

          <table style="border: 1px solid #000;  width: 100%; border-collapse:collapse;">
            <tr>
              <td style="border: 1px solid #000; padding:8px;">S. No.</td>
              <td style="border: 1px solid #000; padding:8px;">Name and address</td>
              ...
              <td style="border: 1px solid #000; padding:8px;">Mention whether loan, gift or donation etc.</td>
            ...
            <tr>
              ...
              <td style="border: 1px solid #000; padding:8px;"><?php echo ucfirst($val->loan_or_gift);?></td>
