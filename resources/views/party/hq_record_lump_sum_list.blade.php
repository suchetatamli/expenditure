  ...
  @if (sizeof($result) >0)
    @foreach($result as $row)
      <tr>
        ...
        <td style="text-align: center;">{{ $row->tran_receiver_name }}</td>
        ...
        <td style="text-align: center;">
          ...
          function(){location.href='{{url("/admin/party_candidate_expense/party-transaction-register-delete/$row->id")}}';})"><i class="fa fa-trash"></i></a>
        </td>
       </tr>
       @php $tot += $row->tran_amount; @endphp
    @endforeach
   @else 
