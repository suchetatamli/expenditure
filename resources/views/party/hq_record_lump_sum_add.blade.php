...
<div class='panel panel-default' >
   <div class='panel-heading'>
      <span class="frm_ttl_sp">Record Lump Sum Amount</span>  
   ...
   <form class='form-horizontal' method='POST' action="{{url('/admin/party_candidate_expense/lump-sum-amount-add-save')}}" id="RecordLumpSumAddForm">
      @csrf
      <div class="panel-body" style="padding:20px 0px 0px 0px">
         ...
         <div class='form-group'>
            <label class="control-label col-sm-2">Name of unit/ Other Political Party <span class="text-danger" title="This field is required">*</span></label>
            <div class="col-sm-9">
...
@php
echo $guideLines = getGuideLines(17);
@endphp
@endsection
