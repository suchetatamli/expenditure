...
<div class='form-group'>
   <label class="control-label col-sm-2">Details of the items<span class="text-danger" title="This field is required">*</span></label>
   <div class="col-sm-9">
...
<div class='form-group'>
   <label class="control-label col-sm-2">Amount Outstandings<span class="text-danger" title="This field is required">*</span></label>
   <div class="col-sm-9">
