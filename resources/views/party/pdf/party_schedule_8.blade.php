 ...
 <div class="tbl_scrl">
      <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" style="border-collapse:collapse; border:1px solid #000;" autosize="1">
         <tr>
            <td colspan="2" align="left" valign="top" style="border-collapse:collapse; border:1px solid #000; padding:5px; font-family: Arial; font-size: 14px; line-height: 20px; font-weight:bold;">Schedule-8</td>
         ...
         <tr>
            <td colspan="6" align="left" valign="top" style="border-collapse:collapse; border:1px solid #000; padding:5px; font-family: Arial; font-size: 14px; line-height: 20px;">Total Expense on Media Advertisement (print and electronic, bulk sms, cable, website, TV Channel etc.) for specific candidate(s) with photo or name of candidate or attributable to any candidate(s) authorized/ incurred by Party Central Head Quarters</td>
         </tr>
         <tr>
            ...
            <td width="18%" align="center" valign="top" style="border-collapse:collapse; border:1px solid #000; padding:5px; font-family: Arial; font-size: 14px; line-height: 20px;">Name of the candidate</td>
            <td width="20%" align="center" valign="top" style="border-collapse:collapse; border:1px solid #000; padding:5px; font-family: Arial; font-size: 14px; line-height: 20px;">Name of media<br>
               (print/electronic/sms/<br>
               cable tv etc
            </td>
            <td width="21%" align="center" valign="top" style="border-collapse:collapse; border:1px solid #000; padding:5px; font-family: Arial; font-size: 14px; line-height: 20px;">Date/s (of print/telecast<br>
               /sms
            </td>
            <td width="21%" align="center" valign="top" style="border-collapse:collapse; border:1px solid #000; padding:5px; font-family: Arial; font-size: 14px; line-height: 20px;">Total Amount (including outstanding amt.) {{--Config::get('constants.text_labels.amount')--}}</td>
         </tr>
        ...
        @php
         ...
         <tr>
            ...
            <td align="center" valign="top" style="border-collapse:collapse; border:1px solid #000; padding:5px; font-family: Arial; font-size: 14px; line-height: 20px;">{{$pd->name_of_media}}</td>
