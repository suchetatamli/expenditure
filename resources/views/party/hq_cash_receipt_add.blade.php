...
<div class='panel panel-default'  >
    <div class='panel-heading'>Cash Receipts from all sources</div>
    
    <form class='form-horizontal' method='POST' action="{{url('/admin/party_income/cash-receipt-save')}}" id="PartyTransactionRegisterCashAdd">
    @csrf
