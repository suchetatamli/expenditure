...
<div class='panel panel-default'>
  ...
  <div class='panel-body' style="padding:20px 0px 0px 0px">
    ...
    <?php if(request()->route()->getActionMethod() == 'getAnnexuref2PartB' && CRUDBooster::myPrivilegeId() == 5){ ?>
    <div style="padding: 10px;">
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
         <td align="left" valign="top" style="font-family: Arial; font-size: 14px; line-height: 20px; font-weight:bold;">Select State to get State-wise Report</td>
       </tr>
       <tr>
