...
<!--	<div class="row">
	...
	<div class="row">		
		...
		<div class="col-md-3">
			<div class="box_content">
				<div class="txt bank">
					<div class="bnk_row"><label>Cash in hand:</label> <span><i class="fa fa-inr"></i> {{formatCurrency($closing_balance_cash)}}</span></div>
					<div class="bnk_row"><label>Bank Balance:</label> <span><i class="fa fa-inr"></i> {{formatCurrency($closing_balance_bank)}}</span></div>
					...
					<div class="bnk_row"><label>Total amount given to State Unit(s):</label> <span><i class="fa fa-inr"></i> {{formatCurrency($exp_state_unit)}}</span></div>
				</div>
			</div>
		</div>
		<div class="col-md-3">
